<template>
  ...
  <article class="prose lg:prose-lg">
    <p>Welcome to GeoCoLab. If you continue to browse and use this website, you are agreeing to comply with and be
       bound by the following terms and conditions of use, which together with our <a href="/about/privacy">privacy policy</a> govern GeoCoLab’s
    ...
    <p>The term GeoCoLab (‘us’ or ‘we’) refers to the owner of the website whose registered office is <em class="text-red-500">TBC</em>. Our company
       registration number is <em class="text-red-500">TBC</em>. The term 'you' refers to the user
       or viewer of our website.</p>

    <p>The use of this website is subject to the following terms of use:</p>

    <ul>
      <li>The content of the pages of this website is for your general information and use only. It is subject to change
          without notice.
      </li>
      <li>This website uses cookies to monitor browsing preferences. If you do allow cookies to be used, the following
          personal information may be stored by us for use by third parties: [insert list of information].
      </li>
      ...
      <li>Your use of any information or materials on this website is entirely at your own risk, for which we shall not
      ...
      <li>This website contains material which is owned by or licensed to us. This material includes, but is not limited
