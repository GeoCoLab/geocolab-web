...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h2 class="page-title">Review applications</h2><p>#TODO</p><!--]-->`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager/review/index.page.vue");
